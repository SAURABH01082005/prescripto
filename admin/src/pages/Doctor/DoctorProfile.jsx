    ...
    <div>
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <p className='flext items-center gap-2 text-3xl font-medium text-gray-700'> {profileData.name}</p>
          ...
          {/* ----------------Doc About----------- */}
          <div>
            <p className='flext items-center gap-1 text-sm font-medium text-neutral-800 mt-3'>About:</p>
