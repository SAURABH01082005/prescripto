...
function Banner() {
  ...
  return (
    <div className='flex bg-(--color-primary) rounded-lg px-6 sm:px-14 lg:px-12 md:mx-10'>
        {/* ------------left side------------- */}
        ...
        <img className='w-full absolute bottom-0 right-0 max-w-md ' src={assets.appointment_img} alt="" /></div>
    </div>
  )
}
