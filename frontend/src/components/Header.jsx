...
function Header() {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-(--color-primary) rounded-lg px-6 md:px-10 lg:px-20'>
            {/* left side */}
            ...
            <div className=' md:w-1/2  relative'>
                <img src={assets.header_img} className="w-full md:absolute button-0 h-auto rounded-lg" alt="" />
            </div>
